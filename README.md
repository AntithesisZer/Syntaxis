...
笔记结构高度依赖主要参考资料的目录（但不会完全与原书结构一致），部分内容被认为是“不必要的”，但为了保持结构的完整性，仍然编写了对应部分内容的章节，但内容保持为空。
...
更多信息来自[中国国家版本馆](https://pdc.capub.cn/)，部分参考资料存在细微版本差异（如印次等），更多信息中使用的是与实际参考资料完全一致的信息。例如在微积分参考资料中存在两本《斯图尔特微积分》，它们的印次都是1，但有不同的分册号，更多信息中的内容是完全相符的。
